...
<div class="row"><!-- row -->
                ...
                <div class="col-lg-6 col-md-3"><!-- widgets column center -->
                    ...
                    <br><br>
                                ...
                                <h2 class="title-median">Shopping Pvt. Ltd.</h2>
                                <p><b>Email id:</b> <a href="#">info@shopping.com</a></p>
                                <p><b>Helpline Numbers </b>
							    <p><b>Corp Office / Postal Address:</b> Coimbatore, Tamilnadu.</p>
							    <p><b>Phone Numbers : </b>+91-9994691111. </p>
                                </div>
...
<div class="col-lg-12">
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				...
				<div class="copyright">
					...
					© 2017, Shopping, All rights reserved
			...
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				...
				<div class="design">
					 ...
					 <a href="#">Franchisee </a> |  <a target="_blank" href="#">Headphones by Shopping</a>
